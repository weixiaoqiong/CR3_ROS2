...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            # Node(
            #     package='tf_extend',
            #     executable='world_to_camera_test',
            #     name='world2cam_test_node',
            #     output='screen',
            #     emulate_tty = True
            # ),   
            ...
            # Node(
            #     package='object_world_pub',
            #     executable='cam_info_fake_pub',
            #     name='cam_info_fake_pub_node',
            #     output='screen',
            #     emulate_tty = True                
            # ),
            Node(
                package='object_world_pub',
                executable='object_world_pub',
                name='object_world_pub_node',
                parameters=[para_dir],                 
                output='screen',
                emulate_tty = True
            )          
